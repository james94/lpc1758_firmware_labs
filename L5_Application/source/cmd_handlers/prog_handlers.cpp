...
// Application Demo Handlers
CMD_HANDLER_FUNC(rgbLedHandler)
{
    /*cmdParams is str passed to you after user's command*/
    if(cmdParams == "test")
    {
        // Sends reply message to user after they send command
        output.printf("OK!\n");
    }
    else
    {
    ...
    // if command was successful return true
    return true;
}
