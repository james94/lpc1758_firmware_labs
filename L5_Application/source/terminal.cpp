...
bool terminalTask::taskEntry()
{
    ...
    cp.addHandler(controlTaskHandler, "task", "task suspend producer\n"
    										  "task resume producer\n"
    										  "task suspend consumer\n"
    										  "task resume consumer");
    cp.addHandler(test, "test1", "output info");
